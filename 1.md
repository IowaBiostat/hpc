...
{% capture _code %}ssh argon.hpc.uiowa.edu{% endcapture %}
...
{% capture _code %}ssh hawkid@argon.hpc.uiowa.edu{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}ssh -p 40 argon.hpc.uiowa.edu{% endcapture %}
{% include prompt.html code=_code %}
