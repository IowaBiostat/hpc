...
In addition to putty, ssh is bundled with [Git Bash](https://git-scm.com/downloads), and is available by default on any [WSL2](https://learn.microsoft.com/en-us/windows/wsl/install) image. 
