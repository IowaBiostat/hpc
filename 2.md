...
{% capture _code %}scp -P 40 file.txt argon.hpc.uiowa.edu:{% endcapture %}
...
{% capture _code %}scp -r -P 40 mydir argon.hpc.uiowa.edu:{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}rsync -avz -e "ssh -p 40" --delete mydir/ argon.hpc.uiowa.edu:mydir/{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}rsync -avz -e "ssh -p 40" --delete argon.hpc.uiowa.edu:mydir/ mydir/{% endcapture %}
{% include prompt.html code=_code %}
