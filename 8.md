...
{% capture _code %}qstat -u pbreheny{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}qstat -q BIOSTAT{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}qhost -h argon-compute-7-11{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}qdel 1022907{% endcapture %}
{% include prompt.html code=_code %}
