...
{% capture _code %}{% include_relative misc/flights.stan %}{% endcapture %}
{% include file.html name="flights.stan" code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}{% include_relative misc/flights.r %}{% endcapture %}
{% include file.html name="flights.R" code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}qlogin -q BIOSTAT -pe smp 10{% endcapture %}
...
<!-- prettier-ignore-start -->
{% capture _code %}q_sub -pe smp 10 -b y Rscript flights.R{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
