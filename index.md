...
- **i-ii:** This material covers submission of R jobs in non-interactive mode (scripts); it has nothing to do with the Argon cluster per se, but you need to know how to do these things before you can run jobs on the cluster.
- **1-9:** What Argon is and how to use it: the basic commands are covered and illustrated with step-by-step examples that you can try out yourself.
