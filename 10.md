...
{% capture _code %}qlogin -q BIOSTAT -pe smp 1{% endcapture %}
...
<!-- prettier-ignore-start -->
{% capture _code %}apptainer pull docker://rocker/r-ver{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}apptainer pull docker://rocker/r-ver:4.5.0{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}apptainer pull docker://rocker/tidyverse{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}apptainer pull docker://bioconductor/r-ver{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}apptainer shell r-ver_latest.sif{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
...
<!-- prettier-ignore-start -->
{% capture _code %}apptainer exec r-ver_latest.sif Rscript sim.R{% endcapture %}
{% include prompt.html code=_code %}
<!-- prettier-ignore-end -->
