...
{% capture _code %}qlogin -q BIOSTAT{% endcapture %}
...
{% capture _code %}qlogin -q BIOSTAT -pe smp 4{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}q_login{% endcapture %}
{% include prompt.html code=_code %}

Or if you want, say, 12 cores:

{% capture _code %}q_login 12{% endcapture %}
{% include prompt.html code=_code %}
...
{% capture _code %}qlogin -q BIOSTAT -pe smp 4 -l mem_384G=true{% endcapture %}
{% include prompt.html code=_code %}

Similarly, if you want to specifically request the lower-memory node for some reason:

{% capture _code %}qlogin -q BIOSTAT -pe smp 4 -l mem_128G=true{% endcapture %}
{% include prompt.html code=_code %}
